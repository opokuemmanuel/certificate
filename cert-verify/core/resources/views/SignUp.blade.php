            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="{{route('Add_Admin')}}" method="post" class="">
                        ...
                        <div class="form-group">
                            <label for="nf-email" class=" form-control-label">Confirm Password</label>
                            <input type="password" id="nf-email" name="Confirm_password" placeholder="Confirm Password" class="form-control" required>
                            <span class="help-block"></span>
                        </div>
