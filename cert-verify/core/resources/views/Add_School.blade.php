        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="{{route('Add_School')}}" method="post" class="">
                        @csrf
                        <div class="form-group">
                            <label for="nf-email" class=" form-control-label">University Name</label>
                            <input type="text" id="nf-email" name="university_name" placeholder="University Name.." class="form-control" required>
                            <span class="help-block"></span>
                        </div>

                        <div class="form-group">
                            <label for="nf-email" class=" form-control-label">Address</label>
                            <input type="email" id="nf-email" name="Address" placeholder="Email Address.." class="form-control" required>
                            <span class="help-block"></span>
                        </div>

                        <div class="form-group">
                            <label for="nf-email" class=" form-control-label">Website</label>
                            <input type="text" id="nf-email" name="Website" placeholder="Website.." class="form-control" required>
                            <span class="help-block"></span>
                        </div>

                        <div class="form-group">
                            <label for="nf-password" class=" form-control-label">Location</label>
                            <input type="text" id="nf-password" name="location" placeholder="Location.." class="form-control" required>
                            <span class="help-block"></span>
                        </div>
