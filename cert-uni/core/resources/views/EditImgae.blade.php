        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form  method="POST" action="{{route('update_image')}}"  class="" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <img src="{{ asset('/core/public/post/'. $arr->image) }}" class="img-responsive" style="width:50px; height:50px"><br><br>
                            <input type="file" name="photo" value="{{$arr->image}}" required>
                        </div>

                        <div class="form-group">
                            <input type="text"  name="university_name" placeholder="department name" class="form-control" value="{{ Auth::user()->university_name}}" required>
