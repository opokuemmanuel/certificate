        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <strong>University</strong> SignUp
                </div>
                <div id="app">
                ...
                <div class="card-body card-block">
                    <form action="{{route('SignUp')}}" method="post" class="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="nf-password" name="password" placeholder="Password.." class="form-control" required>
                            <span class="help-block"></span>
                        </div>

                        <div class="form-group">
                            <label for="nf-password" class=" form-control-label">Confirm Password</label>
                            <input type="text" id="nf-password" name="confirm_password" placeholder="Confirm Password.." class="form-control" required>
                            <span class="help-block"></span>
                        </div>
