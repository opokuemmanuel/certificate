            ...
            <div class="card-body">
                <table class="table table-bordered table-responsive-lg">
                    ...
                    @foreach($pro as $prodd)
                        <tr>
                            <td>
                                <img src="{{ asset('/core/public/post/'. $prodd->image) }}" class="img-responsive" style="width:50px; height:50px">
                            </td>
                            <td>
                                <a href="{{url('/EditImage/'.$prodd->school)}}" class="btn btn-success" style="color: white; margin-top: 5px">Edit</a>
                                <a href="{{url('/deleteImage/'.$prodd->school)}}" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
