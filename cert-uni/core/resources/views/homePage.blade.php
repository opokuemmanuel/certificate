                        ...
                        <li class="drop-down"><a>Membership</a>
                            <ul>
                                ...
                                <li>
                                    ...
                                    <form action="{{ route('Add_image') }}" method="get">
                                        @csrf
                                        <input type="hidden" name="university_name" value="{{ Auth::user()->university_name}}">
                                        <button type="submit" class="btn btn-dark" style="background: transparent; color: black; border: white; margin-left: 10px;">Add School's image</button>
                                    </form>
                                </li>


                                <li>
                                    <form action="{{ route('Edit_image') }}" method="get">
                                        @csrf
                                        <input type="hidden" name="university_name" value="{{ Auth::user()->university_name}}">
                                        <button type="submit" class="btn btn-dark" style="background: transparent; color: black; border: white; margin-left: 10px;">Update Image</button>
                                    </form>
                                </li>
                                ...
                                <li>
                                    <form action="{{ route('Edit_image') }}" method="get">
                                        @csrf
                                        <input type="hidden" name="university_name" value="{{ Auth::user()->university_name}}">
                                        <button type="submit" class="btn btn-dark" style="background: transparent; color: black; border: white; margin-left: 10px;">University detail's</button>
                                    </form>
                                </li>

                                <li>
                                    <form action="{{ route('Student_Info') }}" method="get">
                                        @csrf
                                        <input type="hidden" name="university_name" value="{{ Auth::user()->university_name}}">
                                        <button type="submit" class="btn btn-dark" style="background: transparent; color: black; border: white; margin-left: 10px;">Student Info</button>
                                    </form>
                                </li>
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form  method="POST" action="{{route('add_department')}}"  class="">
                        @csrf
                        ...
                        <div class="form-group">
                            <input type="hidden"  name="school" placeholder="school" class="form-control" value="{{ Auth::user()->university_name}}" required>
                            <span class="help-block"></span>
                        </div>
