        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form  method="POST" action="{{route('add_program')}}"  class="">
                        @csrf

                        <div class="form-group"><label for="vat" class=" form-control-label">Select Department</label>

                            <select name="department" id="SelectLm" class="form-control-sm form-control" required>
                                @foreach($pro as $prodd)
                                <option>{{$prodd->department_name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <input type="text"  name="program_name" placeholder="program name" class="form-control" required>
                            <span class="help-block"></span>
                        </div>

                        <div class="form-group">
                            <input type="hidden"  name="school" placeholder="department" class="form-control" value="{{ Auth::user()->university_name}}" required>
                            <span class="help-block"></span>
                        </div>
