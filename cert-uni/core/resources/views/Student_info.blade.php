        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form  method="POST" action="{{route('add_info')}}"  class="" >
                        @csrf
                        ...
                        <select name="class" id="SelectLm" class="form-control-sm form-control" required>
                            <option aria-disabled=""></option>
                                        @foreach($qual as $qualy)
                                            <option>{{$qualy->qualifications}}</option>
                                        @endforeach
                        </select>
                        </div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Year of completion</label>
                            <input type="text"  name="year" placeholder="year of completion" class="form-control"  required>
                            <span class="help-block"></span>
                        </div>
