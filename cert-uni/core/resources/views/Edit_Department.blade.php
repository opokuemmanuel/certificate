            ...
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form  method="POST" action="{{route('update')}}"  class="">
                        ...
                        <div class="form-group">
                            <input type="text"  name="department" placeholder="department name" class="form-control" value="{{$arr->department_name}}" required>
                            <span class="help-block"></span>
                        </div>

                        <div class="form-group">
                            <input type="hidden"  name="school" placeholder="school" class="form-control" value="{{$arr->school}}" required>
                            <span class="help-block"></span>
                        </div>
