        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form  method="POST" action="{{route('updateProgram')}}"  class="">
                        @csrf
                        <div class="form-group">
                            <input type="hidden"  name="id" placeholder="department name" class="form-control" value="{{$arr->id}}" required>
                            <span class="help-block"></span>
                        </div>

                        <div class="form-group">
                            <input type="hidden"  name="university_name" placeholder="department name" class="form-control" value="{{ Auth::user()->university_name}}" required>
                            <span class="help-block"></span>
                        </div>
...
{{--                            <input type="text"  name="program" placeholder="department name" class="form-control" value="{{$arr->program}}" required>--}}
{{--                            <span class="help-block"></span>--}}
                        </div>

                        <div class="form-group">
                            <input type="text"  name="department" placeholder="school" class="form-control" value="{{$arr->department}}" required>
                            <span class="help-block"></span>
                        </div>
